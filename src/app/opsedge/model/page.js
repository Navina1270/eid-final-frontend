...
export default function ModelPage() {
  return (
    <div className="h-full bg-[#f3f3f3] flex text-[#333333] -m-4"> 
      {/* -m-4 to counteract the main padding if necessary, depends on the layout wrapper */}
      
      {/* Jupyter Sidebar (File Browser) */}
      <div className="w-64 border-r border-gray-300 bg-white flex flex-col hidden lg:flex">
