...
const Visuals = () => {
  ...
  const redirectToVisualChart = (row) => {
    ...
    const redirectURL = `/opsedge/visuals/charts?visualId=${row["visual Id"]}`;
    ...
    <>
      ...
      {!loading && (
        <div className="flex flex-col w-full">
          ...
          <Table
            tableData={visualsList}
            redirectTo={redirectToVisualChart}
            labels={["visual Id", "name", "equipment", "created On"]}
          />
        </div>
      )}
    </>
